...
|
*/
// $config['base_url'] = 'http://accounts.matainja.com';
// $config['base_url'] = 'http://localhost/accounts.matainja.com';
$config['base_url'] = 'http://localhost/accounts-matainja';
...
|
*/
$config['encryption_key'] = 'sOchj0zMELgUxt8NCBVu1HKFvmlbnW23aq5J4';
...
*/
$config['proxy_ips'] = '';
$config['api_key']= 'st12aff34';
$config['admin_email']="hr@matainja.com";
$config['token']= 'a2ty3xc';
