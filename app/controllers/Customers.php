            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    if ($this->input->post('form_action') == 'export_pdf') {
                        ...
                        $styleFormat = $this->excel->getDefaultStyle()->applyFromArray($styleArray);
                        $content = $this->excel->getActiveSheet()->getPageSetup()->setOrientation(PHPExcel_Worksheet_PageSetup::ORIENTATION_LANDSCAPE);
