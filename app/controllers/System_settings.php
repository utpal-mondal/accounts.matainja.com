        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'edit_price' => $this->input->post('edit_price'),
                 'invoice_management-index'=> $this->input->post('invoice_management-index'),
                'invoice_management-add'=> $this->input->post('invoice_management-add'),
                'invoice_management-edit'=> $this->input->post('invoice_management-edit'),
                'invoice_management-delete'=> $this->input->post('invoice_management-delete'),
                'invoice_management-pdf'=> $this->input->post('invoice_management-pdf'),
                ...
                'staff-delete'=> $this->input->post('staff-delete'),
                 'staff-pdf'=> $this->input->post('staff-pdf'),
                'resource-index'=> $this->input->post('resource-index'),
                'resource-add'=> $this->input->post('resource-add'),
                'resource-edit'=> $this->input->post('resource-edit'),
                'resource-delete'=> $this->input->post('resource-delete'),
                  'resource-pdf'=> $this->input->post('resource-pdf'),
                 'holiday-index'=> $this->input->post('holiday-index'),
                'holiday-add'=> $this->input->post('holiday-add'),
                'holiday-edit'=> $this->input->post('holiday-edit'),
                'holiday-delete'=> $this->input->post('holiday-delete'),
                 'assign_rf'=> $this->input->post('assign_rf'),
                'atten_rawrecord'=> $this->input->post('atten_rawrecord'),
                'attendance_add'=> $this->input->post('add_attendance'),
                'attenance_staff'=> $this->input->post('attendance_staff'),
                'atten_report'=> $this->input->post('atten_report'),
                'atten_reportanlysis'=> $this->input->post('atten_reportanlysis'),
                'leave_index'=>$this->input->post('leave-index'),
                'leave_add'=>$this->input->post('leave-add'),
