                            ...
                            <div class="col-sm-5">
                               ...
                               <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        <tbody>
                                        <tr>
                                            <td colspan="2" style="background-color:#FFF;"> IMEI NUMBER</td>
                                        </tr>
                                       
                                         <?php
										 if(!empty($imei)){
											 $i=1;
										  foreach($imei as $iemidetails){ ?>
                                        <tr>
                                        <td><?php echo $i .'.'; ?></td>
                                           <td><input class="checkbox" id="check" type="checkbox" name="check"/></td>  
                                           
                                            <td style="text-align:center"><?php echo $iemidetails->imei_no; ?></td>
                                            
                                            <td><?php echo $iemidetails->status; ?></td>
                                        </tr>
										<?php $i++; }
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <?php if ($Owner || $Admin) {
                                            ...
                                            echo '<tr><td>' . lang("dealer_price") . '</td><td>' . $this->sma->formatMoney($product->price) . '</td></tr>';
                                        ...
                                        <?php } ?>
                                        <?php /*?><?php if ($product->alert_quantity != 0) { ?>
                                            <tr>
