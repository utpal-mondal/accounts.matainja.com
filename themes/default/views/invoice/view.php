            ...
            <div class="col-lg-12">
                ...
                <div class="col-xs-5">
                    ...
                    <div class="col-xs-10">
                        ...
                        <p style="font-weight:bold;"><?= lang("currency"); ?>: <?=strtoupper($inv->currency)?></p>
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="#" class="tip btn btn-danger bpo"
                            ...
                            data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= site_url('invoice_management/delete/' . $inv->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
