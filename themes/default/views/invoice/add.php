          ...
          <div class="col-lg-12">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <?= lang("date", "sldate"); ?>
                <?php echo form_input('date', set_value("date"), 'class="form-control input-tip datetime" id="sldate"'); ?> </div>
            </div>
            <?php } ?>
            <div class="col-md-4">
              <div class="form-group">
                <label><?= lang("ref"); ?></label>
                <?php echo form_input('reference_no', set_value("reference_no"), 'class="form-control input-tip" id="slref"'); ?> </div>
            </div>
              ...
              <div class="form-group">
                ...
                <?php
                    ...
                    if (!empty($billers)) {
                       ...
                       echo form_dropdown('biller', $bl, set_value("biller"), 'id="slbiller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                    }
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <?php 
										...
										echo form_dropdown('currency', $currency, (isset($_POST['currency']) ? $_POST['currency'] : ''), 'id="slcurrency" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("invoice", "slcurrency") . '" style="width:100%;" ');
										?>
                      </div>
                    </div>
                  </div>
              ...
              <div class="form-group">
				...
				echo form_dropdown('payment_mode', $payment_mode, (isset($_POST['payment_mode']) ? $_POST['payment_mode'] : ''), 'id="slpayment_mode" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("payment_mode") . '" style="width:100%;" '); ?> </div>
            </div>
	                </div>
    	        </div>
        	 </div>
            ...
            <div class="col-md-4 commision_fees_block" style="display:none;">
              <div class="form-group">
                <label style="width: 100%;"><?= lang("commision_fee"); ?></label>
               <div style="padding:0px;" class="col-md-8"> 
                <?php 
				echo form_input('commision_fee', (isset($_POST['commision_fee']) ? $_POST['commision_fee'] : ''), 'class="form-control input-tip" id="commision_fee"'); ?> 
                </div>
                <div class="col-md-4"> 
                <?php 
...
--> 
              ...
              <div>
                <table id="gst_calculate" align="right" style="display: none;" class="items table-striped table-bordered table-condensed table-hover sortable_table">
                  <thead>
                  </thead>
                  <tbody>
                    <tr id="first_radio">
                    ...
                    <tr>
                      <td style="text-align:right;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="margin-left: 15px;">CGST@
                        <?php 
              ...
              <div>
              	<table id="overall_total_amount" align="right" style="display: none;" class="items table-striped table-bordered table-condensed table-hover sortable_table">
                  <thead>
                  </thead>
                  <tbody>  
                    <tr>
                      <td style="text-align:right;"><b>
                        <?= lang("total_invoice_amount"); ?>
                        </b></td>
                      <td style="text-align:center; font-weight: bold;" class="total_invoice_amount">0.00</td>
                      </tr>
                  </tbody>
                </table>
              </div>
...
/*$("input[type='radio']").change(function(){
	...
	$(document).on('keyup','#commision_fee',function(){
		$('#commision_fee_percentage').val('');
	})
...
<script type="text/javascript">
	...
	$(document).on('keydown', "#commision_fee", function (e) {
        // Allow: backspace, delete, tab, escape, enter and .
        if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
             // Allow: Ctrl+A, Command+A
            (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) || 
	...
	$(document).on('keydown', "#commision_fee_percentage", function (e) {
        // Allow: backspace, delete, tab, escape, enter and .
        if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
             // Allow: Ctrl+A, Command+A
            (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) || 
