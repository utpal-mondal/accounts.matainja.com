...
<script>
    ...
    $(document).ready(function () {
        ...
        var oTable = $('#ILData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('invoice_management/getinvoices/')?>',
...
<?php if ($this->Owner || ($this->GP && $this->GP['bulk_actions'])) { 
	    ...
	    echo form_open('invoice_management/invoice_actions', 'id="action-form"');
...
<div class="box">
    ...
    <div class="box-header">
        ...
        <h2 class="blue"> <i class="fa fa-print" aria-hidden="true"></i><?=lang('invoice_management')?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            ...
                            <a href="<?=site_url('invoice_management/add')?>">
