...
<div class="box">
    ...
    <div class="box-header">
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i>Edit Invoice</h2>
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                        <input type="radio" name="currency" class="inr_class"/>&nbsp;&nbsp;&nbsp;INR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="currency" class="other_class"/>&nbsp;&nbsp;&nbsp;Others
                                        </div>
                                        </div>
                                        </div>
...
-->
                                        ...
                                        <td style="width:180px;"><input type="text" name="descrption[]" style="padding:7px; width:100%;" class="message" data-increment="<?php echo $i?>" value="<?php echo $description; ?>"/></td>
