                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td><?= lang("invoice"); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="invoice_management-index" <?php echo $p->{'invoice_management-index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="invoice_management-add" <?php echo $p->{'invoice_management-add'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="invoice_management-edit" <?php echo $p->{'invoice_management-edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="invoice_management-delete" <?php echo $p->{'invoice_management-delete'} ? "checked" : ''; ?>>
                                    </td>
                                    <td>
                                         <input type="checkbox" value="1" id="invoice-pdf" class="checkbox" name="invoice_management-pdf" <?php echo $p->{'invoice_management-pdf'} ? "checked" : ''; ?>>
                                        <label for="invoice-pdf" class="padding05"><?= lang('pdf') ?></label>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-center">
                                     ...
                                     <td>
                                         <input type="checkbox" value="1" id="staff-pdf" class="checkbox" name="staff-pdf" <?php echo $p->{'staff-pdf'} ? "checked" : ''; ?>>
                                        <label for="staff-pdf" class="padding05"><?= lang('pdf') ?></label>
                                    </td>
                                  ...
                                  <tr>
                                    <td><?= lang("Resource"); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="resource-index" <?php echo $p->{'resource-index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="resource-add" <?php echo $p->{'resource-add'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="resource-edit" <?php echo $p->{'resource-edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="resource-delete" <?php echo $p->{'resource-delete'} ? "checked" : ''; ?>>
                                    </td>
                                    <td>
                                         <input type="checkbox" value="1" id="resource-pdf" class="checkbox" name="resource-pdf" <?php echo $p->{'resource-pdf'} ? "checked" : ''; ?>>
                                        <label for="resource-pdf" class="padding05"><?= lang('pdf') ?></label>
                                    </td>
                                    ...
                                    <td><?= lang("Holiday"); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="holiday-index" <?php echo $p->{'holiday-index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="holiday-add" <?php echo $p->{'holiday-add'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="holiday-edit" <?php echo $p->{'holiday-edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="holiday-delete" <?php echo $p->{'holiday-delete'} ? "checked" : ''; ?>>
                                    </td>
                                    <td>
                                    </td>
                                 ...
                                 <tr>
                                    <td><?= lang("leave"); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="leave-index" <?php echo $p->{'leave_index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="leave-add" <?php echo $p->{'leave_add'} ? "checked" : ''; ?>>
                                    </td>
                                    <td colspan="2">
                                        <td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="assign_rf" name="assign_rf" <?php echo $p->{'assign_rf'} ? "checked" : ''; ?>>
                                            <label for="assign_rf" class="padding05"><?= lang('assign_rf') ?></label>
                                        </span>
                                 <span style="inline-block">
                        <input type="checkbox" value="1" class="checkbox" id="add_attendance" name="add_attendance" <?php echo $p->{'attendance_add'} ? "checked" : ''; ?>>
                                            <label for="add_attendance" class="padding05"><?= lang('add_attendance') ?></label>
                                        </span>
                                          <span style="inline-block">
                        <input type="checkbox" value="1" class="checkbox" id="attendance_staff" name="attendance_staff" <?php echo $p->{'attenance_staff'} ? "checked" : ''; ?>>
                                            <label for="attendance_staff" class="padding05"><?= lang('attendance_staff') ?></label>
                                        </span>
                                          <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="atten_rawrecord" name="atten_rawrecord" <?php echo $p->{'atten_rawrecord'} ? "checked" : ''; ?>>
                                            <label for="atten_rawrecord" class="padding05"><?= lang('atten_rawrecord') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="atten_report" name="atten_report" <?php echo $p->{'atten_report'} ? "checked" : ''; ?>>
                                            <label for="atten_report" class="padding05"><?= lang('atten_report') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="atten_reportanlysis" name="atten_reportanlysis" <?php echo $p->{'atten_reportanlysis'} ? "checked" : ''; ?>>
                                            <label for="atten_reportanlysis" class="padding05"><?= lang('atten_reportanlysis') ?></label>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
